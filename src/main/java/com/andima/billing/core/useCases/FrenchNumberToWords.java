...
public class FrenchNumberToWords {
    ...
    public String convert(long number) {
        ...
        if(resultat.endsWith("mille ")) resultat = resultat.substring(0, resultat.length()-1);
        else if(resultat.endsWith("millions ")) resultat = resultat.substring(0, resultat.length()-1);
        else if(resultat.endsWith("milliards ")) resultat = resultat.substring(0, resultat.length()-1);
        return resultat;
    }
}
